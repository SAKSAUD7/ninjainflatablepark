    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-6">
                <Link href="/admin/faqs" className="p-2 hover:bg-slate-100 rounded-full transition-colors">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        {form.formState.errors.question && (
                            <p className="text-xs text-red-500 mt-1">{form.formState.errors.question.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {form.formState.errors.answer && (
                            <p className="text-xs text-red-500 mt-1">{form.formState.errors.answer.message}</p>
                        )}
                    </div>
