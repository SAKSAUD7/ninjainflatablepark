                ...
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-sm mt-1">Waiver ID: #{waiver.id.slice(-8).toUpperCase()}</p>
                        </div>
                    </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                            ...
                            <div className="space-y-3">
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-slate-900 mt-1">#{waiver.booking.id.slice(-6).toUpperCase()}</p>
                                </div>
                                <div>
